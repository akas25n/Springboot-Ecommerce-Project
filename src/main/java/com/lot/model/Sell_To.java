...
public class Sell_To {
	 ...
	 * @param phone_office
	 */
	public Sell_To(long tb_id, String title, String name, String street_no, int zip, String city, String country,
			String email, String phone_office) {
		super();
		this.tb_id = tb_id;
